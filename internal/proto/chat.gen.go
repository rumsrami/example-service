...
func WebRPCSchemaHash() string {
	return "a4fdc6d6993d7313905a53c2e256053b6a0b3ee2"
}
...
type Chat interface {
	...
	CreateChatMessage(ctx context.Context, req *ChatMessage) (bool, error)
}
...
func (s *chatServer) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	...
	case "/rpc/Chat/Ping":
		s.servePing(ctx, w, r)
		return
	case "/rpc/Chat/Version":
		s.serveVersion(ctx, w, r)
		return
	case "/rpc/Chat/CreateChatMessage":
		s.serveCreateChatMessage(ctx, w, r)
		return
	default:
...
func (s *chatServer) servePing(ctx context.Context, w http.ResponseWriter, r *http.Request) {
...
func (s *chatServer) servePingJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	var err error
...
func (s *chatServer) serveVersion(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	header := r.Header.Get("Content-Type")
	i := strings.Index(header, ";")
	if i == -1 {
		i = len(header)
...
func (s *chatServer) serveVersionJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	var err error
...
func (s *chatServer) serveCreateChatMessage(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	header := r.Header.Get("Content-Type")
	i := strings.Index(header, ";")
	if i == -1 {
		i = len(header)
	...
	switch strings.TrimSpace(strings.ToLower(header[:i])) {
	case "application/json":
		s.serveCreateChatMessageJSON(ctx, w, r)
	default:
		err := Errorf(ErrBadRoute, "unexpected Content-Type: %q", r.Header.Get("Content-Type"))
		RespondWithError(w, err)
	}
...
func (s *chatServer) serveCreateChatMessageJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	var err error
	ctx = context.WithValue(ctx, MethodNameCtxKey, "CreateChatMessage")
	reqContent := struct {
		Arg0 *ChatMessage `json:"req"`
	}{}
	...
	func() {
		...
		ret0, err = s.Chat.CreateChatMessage(ctx, reqContent.Arg0)
	}()
	respContent := struct {
		Ret0 bool `json:"res"`
	}{ret0}
...
func (c *chatClient) Ping(ctx context.Context) (bool, error) {
	out := struct {
		Ret0 bool `json:"status"`
	}{}
...
func (c *chatClient) Version(ctx context.Context) (*Version, error) {
	out := struct {
		Ret0 *Version `json:"version"`
	}{}
...
func (c *chatClient) CreateChatMessage(ctx context.Context, req *ChatMessage) (bool, error) {
	in := struct {
		Arg0 *ChatMessage `json:"req"`
	}{req}
	out := struct {
